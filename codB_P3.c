...
//   pthread_create(&threadID[0], &attr[0], return_Avg(&avg_value), &threadID[0]);
...
//   pthread_create(&threadID[2], &attr[1], return_Max(&max_value), &threadID[2]);
...
//   // Critical section
//   (*arg) = tmp/50.0; // Se calcula el promedio
